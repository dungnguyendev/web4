    ...
    return (
        <div className={`p-4 rounded-lg bg-[#ffffff1a] border border-[#464646] shadow-sm ${className}`}>
            <div className='h-[300px] rounded-lg overflow-hidden'>
                <Image src={image ? image : 'https://i.pinimg.com/564x/cc/c9/df/ccc9df4d1bd3a6598d6f331ec8f8684f.jpg'} width={500} height={500} alt='' className='w-full h-full object-cover' />
            </div>
