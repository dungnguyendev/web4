                        ...
                        >
                            <div className="mt-[4.8rem]">
                                ...
                                <div className='p-3 flex  mt-3 flex-col gap-2'>
                                    ...
                                    <div>
                                        <span className="font-sm font-semibold">Pool: {ethers.utils.formatEther(String(isDetail[7]._hex))}/{ethers.utils.formatEther(String(isDetail[3]._hex))} ETH</span>
                                    </div>
                                    {
                                        address ? (
                                            <button
                                                className={`text-sm mt-2 duration-150 active:scale-90 py-2 font-semibold w-full rounded-lg  text-white ${isDonate ? 'bg-red-500' : 'bg-blue-700'}`}
                                                    ...
                                                    <Web3Button
                                                        ...
                                                        action={(contract) => {
                                                            if (Number(isValueDonate) < 0.01) {
                                                                ...
                                                                contract.call("donateToCampaign", [isChoose], {value: ethers.utils.parseUnits(String(ethers.utils.parseEther(isValueDonate)), 18)})
                                                            }
                                                        }
                                                        }
                                                        onSuccess={() => {
